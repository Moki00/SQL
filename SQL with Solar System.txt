...
SELECT ROUND(AVG(mass)) FROM solar_system_objects;
SELECT body, ROUND(MAX(mass)) FROM solar_system_objects;
SELECT body, MIN(mass) FROM solar_system_objects;

SELECT ROUND(SUM(mass)) AS Total_Mass_of_Solar_System FROM solar_system_objects;

SELECT body, SUM(mass) AS total_mass FROM solar_system_objects GROUP BY body HAVING total_mass>500 AND total_mass<123456;
